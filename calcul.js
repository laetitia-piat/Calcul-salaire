document.getElementById("calcul").addEventListener("click", function () {
  let nombreHeureTotale = document.getElementById("heureTotale").value,
    ...
    indemnitePrecarite =
      ((salaireBase + indemniteSujetionSpeciale + 238 + majoDimanche) * 10) /
      100,
    indemniteCongesPayes =
      ((salaireBase +
        indemniteSujetionSpeciale +
        238 +
        majoDimanche +
        indemnitePrecarite) *
        10) /
      100,
    indemniteCongesPayesDim = 5.77 * nombreHeureDimanche,
    salaireBrut =
      salaireBase +
      238 +
      indemniteSujetionSpeciale +
